        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (fs.existsSync(this.installInfoPath)) {
                    const content = yield fs.promises.readFile(this.installInfoPath, 'utf-8');
    ...
    writeInstallInfo(installInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield fs.promises.writeFile(this.installInfoPath, JSON.stringify(installInfo, null, 2), 'utf-8');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (fs.existsSync(metaPath)) {
                    const metaContent = yield fs.promises.readFile(metaPath, 'utf-8');
...
class Handles {
    ...
    static getVersion(pluginName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (hasFile) {
                const packageInfo = JSON.parse(yield fs.promises.readFile(packagePath, 'utf-8'));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const item of items) {
                    ...
                    try {
                        const content = yield fs.promises.readFile(setupPath, 'utf-8');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (fs.existsSync(zipFilePath)) {
                    ...
                    yield fs.promises.mkdir(extractTempDir, { recursive: true });
                    ...
                    // 3) 否则使用解压根目录
                    const topEntries = yield fs.promises.readdir(extractTempDir, { withFileTypes: true });
                ...
                // 确保目标目录存在
                yield fs.promises.mkdir(targetPath, { recursive: true });
                ...
                function checkConflicts(srcDir_1, destDir_1) {
                    return __awaiter(this, arguments, void 0, function* (srcDir, destDir, relativePath = '') {
                        const items = yield fs.promises.readdir(srcDir, { withFileTypes: true });
                        for (const item of items) {
                            ...
                            if (item.isDirectory()) {
                                ...
                                // 检查文件是否已存在
                                try {
                                    yield fs.promises.access(destPath);
                                ...
                                for (const fileRel of files) {
                                    ...
                                    try {
                                        ...
                                        if (stat.isDirectory()) {
                                            ...
                                            yield fs.promises.mkdir(dirname(destPath), { recursive: true });
                ...
                if (extractTempDir && fs.existsSync(extractTempDir)) {
                    try {
                        yield fs.promises.rm(extractTempDir, { recursive: true, force: true });
                        const parentExtractDir = join(getGroupPath(pluginName, group), '__extract');
                        // 若父目录为空则清理
                        try {
                            const remain = yield fs.promises.readdir(parentExtractDir);
                            if (remain.length === 0) {
                                yield fs.promises.rm(parentExtractDir, { recursive: true, force: true });
                            }
                        }
                        catch (_c) { }
                    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const relativeFilePath of component.copiedFiles) {
                    ...
                    try {
                        // 检查文件是否存在
                        yield fs.promises.access(fullFilePath);
                        // 删除原文件
                        yield fs.promises.unlink(fullFilePath);
                ...
                const cleanupEmptyDirs = (dirPath) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        // 检查目录是否为空
                        const remainingItems = yield fs.promises.readdir(dirPath);
                        if (remainingItems.length === 0) {
                            yield fs.promises.rmdir(dirPath);
...
class Pack {
    ...
    static packItem(assetItemPath_1) {
        return __awaiter(this, arguments, void 0, function* (assetItemPath, pluginName = 'pack_demo') {
            try {
                ...
                // 如果已有旧内容，删除后重建
                yield fs.promises.rm(targetRoot, { recursive: true, force: true }).catch(() => { });
                yield fs.promises.mkdir(targetItemDir, { recursive: true });
                const copiedFiles = [];
                // 递归复制目录
                ...
                if (fs.existsSync(sourceMeta) && fs.statSync(sourceMeta).isFile()) {
                    ...
                    yield fs.promises.copyFile(sourceMeta, targetMeta);
    ...
    static copyDirectory(srcDir, destDir, onCopied) {
        return __awaiter(this, void 0, void 0, function* () {
            yield fs.promises.mkdir(destDir, { recursive: true });
            const items = yield fs.promises.readdir(srcDir, { withFileTypes: true });
            for (const item of items) {
                const srcPath = join(srcDir, item.name);
                const destPath = join(destDir, item.name);
    ...
    static writeSetupJson(setupPath, info) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fs.promises.writeFile(setupPath, JSON.stringify(data, null, 2), 'utf-8');
        });
    }
}
