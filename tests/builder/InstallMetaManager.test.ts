...
import { IAppendFactory, IAppendTable, IAppendGui, IComponentInfo } from "../../packages/builder/src/Builder/Defined";
...
const test_03 = () => {
    return new Promise((resolve, reject) => {
        test('测试InstallMetaManager的安装记录与查询', async () => {
            ...
            let appendScripts: Array<IAppendFactory | IAppendTable | IAppendGui> = []
            // 记录安装信息
