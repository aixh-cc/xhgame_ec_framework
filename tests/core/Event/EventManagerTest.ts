...
class EventManagerTest {
    ...
    public test_1() {
        ...
        // 断言
        console.assert(this._testCheck('发送与接受', JSON.stringify(emit_arr) == JSON.stringify(on_arr), true))
    }
    ...
    public test_2() {
        ...
        // 断言
        console.assert(this._testCheck('测试取消监听1', JSON.stringify(emit_arr) == JSON.stringify(on_arr), false))
        console.assert(this._testCheck('测试取消监听2', JSON.stringify(effective_emit_arr) == JSON.stringify(on_arr), true))
    }
    ...
    public test_3() {
        ...
        // 断言
        console.assert(this._testCheck('测试多个相同监听1', emit_arr[5 - 1] == on_arr[on_arr.length - 1], true))
    }
